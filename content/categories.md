...
`type` | string | (_obosolete_) Specify the "type" of the content ("category" by default)
...
`see_all_button_text` | string | (_obosolete_)
`apply_filters_recursively` | boolean | (_obosolete_)
